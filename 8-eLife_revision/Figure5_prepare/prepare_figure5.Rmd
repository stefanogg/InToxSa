...
```{r}
conver_plots <- readRDS("../Genetic_pairs/processed_data/gene_convergence/PI_discordant/convergence_plots.Rda")
```

# Tree

```{r}
p3 <- readRDS("../Genetic_pairs/processed_data/gene_convergence/PI_discordant/tree_with_mutations.Rda") +
  ylim(0, 80)
p3
```
...
# ggsave("figures/Figure5.pdf", width = 18, height = 12)
```
