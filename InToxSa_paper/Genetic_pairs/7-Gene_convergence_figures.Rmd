...
```{r}
df_PI_NEB <- readRDS("../../../VANANZ_phenotypes_local/Genetic_pairs_analysis_Oct_2020/processed_data/PI/dataframes/parameters/PI_sample_parameters_plateGPV1.Rda")

df_PI_NEB_wells <- readRDS("../../../VANANZ_phenotypes_local/Genetic_pairs_analysis_Oct_2020/processed_data/PI/dataframes/parameters/PI_parameters_plateGPV1.Rda")
```
...
```{r}
f <- "~/OneDrive - The University of Melbourne/R/VANANZ_phenotypes_local/Genetic_pairs_analysis_Oct_2020/raw_data/operetta/Cell_count_corrected.df.Rda"

Cell_count.df <- readRDS(f) %>%
  mutate(cell_id = str_c(sample_id, plate_number, plate_replicate, replicate, timepoint, well, Field, Object_No, sep = "_"))

f <- "~/OneDrive - The University of Melbourne/R/VANANZ_phenotypes_local/Genetic_pairs_analysis_Oct_2020/raw_data/operetta/Spot_Cell_count.df.Rda"

Spot_Cell_count.df <- readRDS(f)
