...
As of 12 October 2020, we have now parsed cell death data as single experiments that can now be concatenated.
...
Two experiments (6 replicates) for each of plates 1-6 and GP1-GP7 and one experiment (one replicate) for each of plates P1, P2, M1, M2. In total 30 experiments.
