...
Standardise the different repeated experiments according to JE2 Try to standardise the different repeated experiments according to JE2 (y-mean(JE2)/std(JE2))
