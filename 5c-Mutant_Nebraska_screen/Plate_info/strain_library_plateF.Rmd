...
setwd("~/Documents/Travail/Abdou_project/Staph_infection_project/Convergent_SSR_GWAS_mutant_screen/plate_randomisation/")
# Load list of isolates and episodes
data <- read_csv("isolates_data_plateF.csv")
```
