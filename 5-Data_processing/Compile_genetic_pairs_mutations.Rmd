...
dir.create(dir)
f <- "~/Documents/Github/Transfer_with_server/all_pair_id_snps.mask.tab"
fname <- basename(f)
...
```{r}
f <- "~/Documents/Github/Transfer_with_server/denovo_mutation_counts.tab"
fname <- basename(f)
...
```{r}
f <- "~/Documents/Github/Transfer_with_server/mutated_genes_cdhit_FPR3757_blastp.tab"
fname <- basename(f)
file.copy(f, dir)
...
f <- "~/Documents/Github/Transfer_with_server/Sa_BPH2947_FPR3757_blastp.tab"
fname <- basename(f)
...
```{r}
f <- "~/Documents/Github/Transfer_with_server/BPH2947_mutation_counts.tab"
fname <- basename(f)
file.copy(f, dir)
