...
dir.create(dir)
f <- "~/Documents/Github/Transfer_with_server/all_snps.mask.tab"
fname <- basename(f)
...
```{r}
f <- "~/Documents/Github/Transfer_with_server/mutated_proteins.cd-hit.tab"
fname <- basename(f)
# file.copy(f, str_c(dir, fname), overwrite = T)
...
f <- "~/Documents/Github/Transfer_with_server/mutated_proteins.cd-hit.representative.tab"
fname <- basename(f)
# file.copy(f, str_c(dir, fname), overwrite = T)
...
```{r}
f <- "~/Documents/Github/Transfer_with_server/mutated_proteins_FPR3757_blastp.tab"
fname <- basename(f)
# file.copy(f, str_c(dir, fname), overwrite = T)
...
```{r}
f <- "~/Documents/Github/Transfer_with_server/all_mutated_intergenic_promoters.bed"
fname <- basename(f)
...
```{r}
f <- "~/Documents/Github/Transfer_with_server/all_snps.features.bed"
fname <- basename(f)
...
f <- "~/Documents/Github/Transfer_with_server/special_features.tab"
fname <- basename(f)
file.copy(f, str_c(dir, fname), overwrite = F)
...
f <- "~/Documents/Github/Transfer_with_server/Sa_NCTC8325_promoters.bed"
fname <- basename(f)
file.copy(f, str_c(dir, fname), overwrite = F)
...
```{r}
f <- "~/Documents/Github/Transfer_with_server/sRNA_USA300_FPR3757.bed"
fname <- basename(f)
file.copy(f, str_c(dir, fname), overwrite = F)
