...
The 2 pairs missing from snippy have 0 mutations. These could be interesting pairs for long reads sequencing or at least they should be checked for structural variants based on short reads data!

# Convergence among 10 pairs (8 with mutations detected)
...
df_pair_GC %>%
  saveRDS(str_c(subdir, "df_cleaned_pair_GC.Rda"))
```
