...
```{r}
f <- "~/Documents/Transfer_with_server/all_mask.deletions.bedg"
fname <- basename(f)
...
```{r}
f <- "~/Documents/Transfer_with_server/all_mask.deletions.gff"
fname <- basename(f)
...
```{r}
f <- "~/Documents/Transfer_with_server/all_mask.insertion.pairs.bed"
fname <- basename(f)
file.copy(f, str_c(dir, fname), overwrite = F)
...
```{r}
f <- "~/Documents/Transfer_with_server/all_insertion.pairs.annotated.tab"
fname <- basename(f)
...
```{r}
f <- "~/Documents/Transfer_with_server/all_subtract.gff"
fname <- basename(f)
file.copy(f, str_c(dir, fname), overwrite = F)
