...
```{r}
PI_kinetics_outliers_Nebraska <- read.csv("~/Documents/Travail/Abdou_project/Staph_infection_project/github_analysis/VANANZ_phenotypes/Mutant_Nebraska_screen/Raw_data/PI_kinetics_outliers_Nebraska.csv", sep="", stringsAsFactors=FALSE) %>%
